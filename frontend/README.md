...
- [Resume Optimizer Frontend](#resume-optimizer-frontend)
  - [🌟 Overview](#-overview)
    - [Key Features](#key-features)
  - [� Quick Start in 5 Steps](#-quick-start-in-5-steps)
    - [Prerequisites](#prerequisites)
    - [Steps](#steps)
      - [Step 1: Clone and navigate to frontend](#step-1-clone-and-navigate-to-frontend)
      - [Step 2: Install dependencies](#step-2-install-dependencies)
      - [Step 3: Configure API endpoint (optional, if backend not on localhost:8080)](#step-3-configure-api-endpoint-optional-if-backend-not-on-localhost8080)
  ...
  - [���️ Technology Stack](#️-technology-stack)
    ...
    - [HTTP and State Management](#http-and-state-management)
    - [Testing](#testing)
  ...
  - [🚀 Getting Started Without Docker](#-getting-started-without-docker)
    ...
    - [Step 4: Start Development Server](#step-4-start-development-server-1)
    - [Step 5: Open in Browser](#step-5-open-in-browser-1)
    - [Verify Setup](#verify-setup)
    - [Development Setup](#development-setup)
      - [Configure IDE/Editor](#configure-ideeditor)
      - [Enable Hot Reload Features](#enable-hot-reload-features)
  ...
  - [🔌 API Integration](#-api-integration)
    ...
    - [Using API in Components](#using-api-in-components)
  ...
  - [🤝 Contributing](#-contributing)
    - [Development Workflow](#development-workflow-2)
