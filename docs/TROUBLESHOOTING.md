...
echo "=== Services Check ==="
echo -n "LLM API: "
curl -s http://localhost:11434/api/tags > /dev/null && echo "✓ Running" || echo "✗ Not available"
echo -n "Backend: "
curl -s http://localhost:8080/api/health > /dev/null && echo "✓ Running" || echo "✗ Not available"
echo -n "Frontend: "
curl -s http://localhost:5173 > /dev/null && echo "✓ Running" || echo "✗ Not available"
echo ""
echo "=== File Check ==="
