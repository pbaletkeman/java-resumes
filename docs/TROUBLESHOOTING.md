...
echo -n "Backend: "
curl -s http://localhost:8080/api/health > /dev/null && echo "✓ OK" || echo "✗ FAILED"
echo -n "Frontend: "
...
test -d uploads && echo "✓ uploads/ exists" || echo "✗ uploads/ missing"
test -d prompts && echo "✓ prompts/ exists" || echo "✗ prompts/ missing"
```
