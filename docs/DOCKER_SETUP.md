...
- [Docker Setup Guide](#docker-setup-guide)
  ...
  - [🐳 Available Docker Compose Configurations](#-available-docker-compose-configurations)
    - [Quick Start - Choose Your Setup](#quick-start---choose-your-setup)
      - [Option 1: Lightweight Frontend + Backend (No Database)](#option-1-lightweight-frontend--backend-no-database)
      - [Option 2: Frontend + Backend with SQLite](#option-2-frontend--backend-with-sqlite)
      - [Option 3: Frontend + Backend with PostgreSQL 17](#option-3-frontend--backend-with-postgresql-17)
      - [Option 4: Full Stack with PostgreSQL + Ollama](#option-4-full-stack-with-postgresql--ollama)
    - [Stopping Services](#stopping-services)
  - [🏗️ Service Architecture](#️-service-architecture)
    - [Standard Setup (3 Services)](#standard-setup-3-services)
    - [Full Stack Setup (4 Services)](#full-stack-setup-4-services)
  - [Service Details](#service-details)
    - [Frontend Service](#frontend-service)
    - [Backend Service](#backend-service)
    - [PostgreSQL Service (PostgreSQL configs only)](#postgresql-service-postgresql-configs-only)
    - [Ollama Service (Full-stack only)](#ollama-service-full-stack-only)
  - [Health Check Endpoints](#health-check-endpoints)
    - [Overall System Health](#overall-system-health)
    - [Individual Health Checks](#individual-health-checks)
    - [Example Health Response](#example-health-response)
    - [Health Check Status Meanings](#health-check-status-meanings)
  ...
  - [Monitoring and Logging](#monitoring-and-logging)
    ...
    - [View Logs](#view-logs)
    - [Container Health and Resources](#container-health-and-resources)
  - [Troubleshooting](#troubleshooting)
    - [Backend Fails to Start](#backend-fails-to-start)
    - [Database Connection Errors](#database-connection-errors)
    - [Frontend Cannot Connect to Backend](#frontend-cannot-connect-to-backend)
