...
- [Frontend Screenshots Guide](#frontend-screenshots-guide)
  - [📸 Frontend UI Screenshots](#-frontend-ui-screenshots)
    - [Quick Reference](#quick-reference)
  - [👩‍💻 1. Main Upload Tab](#-1-main-upload-tab)
    - [What to Show](#what-to-show)
    - [Components to Include](#components-to-include)
    - [Capture Instructions](#capture-instructions)
    - [Verification Checklist](#verification-checklist)
  - [📄 2. File History Panel](#-2-file-history-panel)
    - [What to Show](#what-to-show-1)
    - [Components to Include](#components-to-include-1)
    - [Capture Instructions](#capture-instructions-1)
    - [Verification Checklist](#verification-checklist-1)
  - [3. Additional Tools Tab](#3-additional-tools-tab)
    - [What to Show](#what-to-show-2)
    - [Components to Include](#components-to-include-2)
    - [Capture Instructions](#capture-instructions-2)
    - [Verification Checklist](#verification-checklist-2)
  - [4. Light Theme](#4-light-theme)
    - [What to Show](#what-to-show-3)
    - [Capture Instructions](#capture-instructions-3)
    - [Verification Checklist](#verification-checklist-3)
  - [5. Dark Theme](#5-dark-theme)
    - [What to Show](#what-to-show-4)
    - [Capture Instructions](#capture-instructions-4)
    - [Verification Checklist](#verification-checklist-4)
  - [6. Responsive Mobile View](#6-responsive-mobile-view)
    - [What to Show](#what-to-show-5)
    - [Capture Instructions](#capture-instructions-5)
    - [Verification Checklist](#verification-checklist-5)
  - [📋 General Screenshot Guidelines](#-general-screenshot-guidelines)
    - [Before Capturing](#before-capturing)
    - [During Capturing](#during-capturing)
  ...
  - [📞 Troubleshooting](#-troubleshooting)
    - [Images Look Blurry](#images-look-blurry)
    - [Text Not Readable](#text-not-readable)
